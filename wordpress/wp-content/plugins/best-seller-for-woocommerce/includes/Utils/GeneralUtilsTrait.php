...
trait GeneralUtilsTrait {
	...
	public static function loader_html( $prefix = null ) {
		?>
		<div style="width:100%;height:100%;position:absolute;left:0;top:0;z-index:1000;" class="loader hidden <?php echo esc_attr( ! empty( $prefix ) ? $prefix . '-loader' : '' ); ?>">
	...
	public static function clipboard_icon( $target ) {
		?>
		<span class="gpls-general-clipboard-icon d-inline-block">
