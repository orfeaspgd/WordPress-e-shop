<?php
namespace GPLSCore\GPLS_PLUGIN_WOBTSLR\Settings\SettingsBase;

defined( 'ABSPATH' ) || exit;

use GPLSCore\GPLS_PLUGIN_WOBTSLR\Settings\SettingsFields\Field;
...
trait SettingsFormTrait {
	 ...
	 * @return void
	 */
	protected function settings_listing_html( $tab, $section = 'general' ) {
				...
				<div class="row">
					<div class="col">
						<div class="settings-list row">
							<?php
							$tab_fields = $this->get_tab_fields( $tab, $section );
	 ...
	 * @return void
	 */
	public function print_settings( $tab, $section = 'general', $full_form = true ) {
		...
		$this->settings_listing_html( $tab, $section );

		if ( $full_form ) {
			$this->form_close();
		}

		do_action( $this->id . '-settings-tabs-action', $this );
	}
